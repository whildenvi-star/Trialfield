...
- [x] **Phase 4: Synced Harvest CropLot Wiring** - Gap closure: Add CropLot creation to staged-ops approve flow for synced harvests (completed 2026-02-26)
...
- [x] 04-02-PLAN.md — Report assembler lot number fallback and review page CropLot-aware toast messages
...
| 4. Synced Harvest CropLot Wiring | 2/2 | Complete   | 2026-02-26 |
