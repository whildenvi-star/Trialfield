...
// CR-05: GET handler was missing — any path fetching a single contract by ID through the
// portal proxy received a 405 Method Not Allowed from Next.js.
