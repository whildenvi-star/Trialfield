...
const EDITABLE_FIELDS = new Set(['crop', 'registry_crop_id', 'irrigated', 'organic', 'reported', 'grain_plant_date', 'use', 'prevented_planting', 'prevented_planting_acres', 'registry_field_id', 'field_name'])
